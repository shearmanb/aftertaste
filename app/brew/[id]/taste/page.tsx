...
export default function TastePage() {
  ...
  const [drinkingTempF, setDrinkingTempF] = useState("");
  ...
  function addCustomTag() {
    ...
    if (t && !flavorTags.includes(t)) {
      setFlavorTags((prev) => [...prev, t]);
    }
    setCustomTag("");
  }
  ...
  async function submit() {
    ...
    await fetch(`/api/brews/${id}/taste`, {
      ...
      body: JSON.stringify({
        ...
        chocolate,
        sourness,
        drinkingTempF: drinkingTempF ? parseInt(drinkingTempF) : undefined,
        flavorTags,
    ...
    <div className="min-h-screen bg-stone-950 px-4 pt-6 pb-10 max-w-lg mx-auto">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-stone-900 border border-stone-800 rounded-xl p-5 space-y-5">
          ...
          <TastingSlider label="Fruit" value={fruit} onChange={setFruit} lowLabel="None" highLabel="Intense" />
          <TastingSlider label="Chocolate / Sweetness" value={chocolate} onChange={setChocolate} lowLabel="None" highLabel="Rich" />
          <TastingSlider label="Bitterness" value={bitterness} onChange={setBitterness} lowLabel="None" highLabel="Harsh" />
        ...
        <div className="bg-stone-900 border border-stone-800 rounded-xl p-5 space-y-4">
          ...
          <div>
            <label className="text-stone-400 text-sm block mb-1">Drinking temp (°F, optional)</label>
            <input
              type="number"
              placeholder="e.g. 145"
              value={drinkingTempF}
              onChange={(e) => setDrinkingTempF(e.target.value)}
          ...
          <div>
            <label className="text-stone-400 text-sm block mb-1">Initial thoughts (optional)</label>
            <textarea
              placeholder="First impressions, anything notable..."
